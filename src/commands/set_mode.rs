use crate::commands::{CursorMoveDown, LllCommand, LllRunnable};
...
impl SetMode {
    ...
    pub fn set_mode(&self, entry: &mut LllDirEntry, initial: String) -> bool {
